    ...
    <div class="container">
        ...
        <form action="{{ route('students.search') }}" method="GET" class="mb-2">
            <div class="input-group">
                <input type="text" class="form-control me-2" style="max-width: 220px;"
                    placeholder="Search Student's name" name="search" value="{{ request('search') }}">
            ...
            <div>
                <table class="table table-hover table-bordered" style="border-radius: 8px; background-color: #f8f9fa;">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-1">
                        ...
                        <h5 class="text-right">Total Students: {{ students::count() }}</h5>
                        <!-- Total Students across all pages -->
                    </div>
                        ...
                        <form method="post" action="{{ route('std.addNewStudent') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="name" name="name" value="{{ old('name') }}"
                                    placeholder="Last Name, First Name M.I." pattern="[A-Za-z\s\,\.]+"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="{{ route('students.update', $std->id) }}">
                                ...
                                <div class="mb-3">
                                    <label for="age" class="form-label"><strong>Age</strong></label>
                                    <input type="number" class="form-control" id="age" name="age" value="{{ $std->age }}"
                                        placeholder="Enter age" min="1" max="120">
                                    @error('age')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="gender" name="gender">
                                        ...
                                        <option value="Female" {{ $std->gender == 'Female' ? 'selected' : '' }}>Female
                                        </option>
                                    </select>
                                    @error('gender')
                                        <span class="text-danger">{{ $message }}</span>
